...
# Command-Shift-P "Display Color Scheme Rule" to see the scope at the cursor.
# http://www.sublimetext.com/forum/viewtopic.php?f=5&t=2698
# https://raw.github.com/ajpalkovic/SublimePlugins/master/theme.py
